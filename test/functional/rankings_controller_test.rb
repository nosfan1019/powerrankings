...
class RankingsControllerTest < ActionController::TestCase
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post :create, ranking: { rank: @ranking.rank, source_id: @ranking.source_id, sport_id: @ranking.sport_id, team_id: @ranking.team_id }
    end
  ...
  test "should update ranking" do
    put :update, id: @ranking, ranking: { rank: @ranking.rank, source_id: @ranking.source_id, sport_id: @ranking.sport_id, team_id: @ranking.team_id }
    assert_redirected_to ranking_path(assigns(:ranking))
  end
